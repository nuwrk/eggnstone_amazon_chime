...
class MeetingScreen extends StatefulWidget {
  ...
  MeetingScreen(this.data);

  @override
  _MeetingScreen createState() => _MeetingScreen();
}

class _MeetingScreen extends State<MeetingScreen> implements ApiStateListener {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        home: Scaffold(
            appBar: AppBar(title: Text('Chime')),
            floatingActionButton:  Row(
              ...
              children: [
                new FloatingActionButton(
                  ...
                  heroTag: null,
                  onPressed: (){
                    api.endMeeting(widget.data.joinInfo.meetingResponse.meeting.meetingId);
                  },
                ),
                new FloatingActionButton(
  ...
  Future<void> _createMeetingSession() async {
    ...
    try {
      ...
      meetingSessionState = await MeetingSessionCreator(widget.data).create();
  ...
  Future<void> share(MeetingData data) async {
    await FlutterShare.share(
        title: "title :-" + data.joinInfo.meetingResponse.meeting.externalMeetingId,
        text: "meeting id :- " + data.joinInfo.meetingResponse.meeting.meetingId + "       " +
            "title :-" + data.joinInfo.meetingResponse.meeting.externalMeetingId,
        linkUrl: "title :-" + data.joinInfo.meetingResponse.meeting.externalMeetingId,
        chooserTitle: 'Chime'
    );
  }
}
